...
class LumoWebView: WKWebView {
    override var inputAccessoryView: UIView? {
        nil  // Completely removes the bar above the keyboard
    }
}
...
struct WebView: UIViewRepresentable {
    ...
    class Coordinator: NSObject, WKNavigationDelegate, UIScrollViewDelegate {
        ...
        init(_ parent: WebView, webComposerBridge: WebComposerReceiving) {
            self.parent = parent
        ...
        private func shouldOpenInExternalBrowser(url: URL) -> Bool {
            ...
            if urlString.contains("proton.me/legal") || urlString.contains("proton.me/business") || urlString.contains("proton.me/about") {
                return true
            }
        ...
        func webView(_ webView: WKWebView, didFail navigation: WKNavigation!, withError error: Error) {
            ...
            DispatchQueue.main.async {
                ...
                if nsError.domain == NSURLErrorDomain
                    && (nsError.code == NSURLErrorNotConnectedToInternet || nsError.code == NSURLErrorNetworkConnectionLost || nsError.code == NSURLErrorCannotConnectToHost)
                {
    ...
    func makeUIView(context: Context) -> WKWebView {
        ...
        if let externalLinkScript = jsBridge.createUserScript(.externalLinkHandler, injectionTime: .atDocumentEnd, forMainFrameOnly: false) {
...
extension WebView {
    func isCrossDomainTransition(from sourceURL: String, to destinationURL: String) -> Bool {
        ...
        return (isDestinationLumo && isSourceAccount) || (isDestinationAccount && isSourceLumo)
    }
}
